...
const ComplianceRisks = ({complianceRisks, getComplianceRisks}) => {
    ...
    return (
        <Container className={styles.complianceRisks}>
                ...
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell align={'right'} colSpan={4}>
                            <Link className={styles.addButton} to={{ pathname: `/complianceRisks/create` }}>
                                <Button variant={'outlined'} color={'secondary'}>Добавить комплаенс-риск</Button>
                            </Link>
                        </TableCell>
                    </TableRow>
                </TableBody>
