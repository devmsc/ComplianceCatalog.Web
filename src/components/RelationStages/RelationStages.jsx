...
const RelationStages = ({relationStages, getRelationStages}) => {
    ...
    return (
        <Container className={styles.relationStages}>
                ...
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell align={'right'} colSpan={4}>
                            <Link className={styles.addButton} to={{ pathname: `/relationStages/create` }}>
                                <Button variant={'outlined'} color={'secondary'}>Добавить этап взаимоотношений с клиентом</Button>
                            </Link>
                        </TableCell>
                    </TableRow>
                </TableBody>
